...
<style>
    ...
    .rss_create .circle-icon,
    .rss_create .vertical_line {
        top: 5
    }
...
@section('content')
    ...
    <div class=" create-rss">
        <form id="rss-form" action="{{ route('rss.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row justify-content-center w-100 m-0 p-0">
                <div class="col-12 rss-first-link">
                    ...
                    <input name="link" value="" id="rss_link" style="padding-left: 15px !important;"
                        class="form-control col-8 p-0" placeholder="Your link here" type="text">

                    <div class=" rss-first-btn col-2"><input type="button" class="rss-btn" value="Fetch"></div>
                    <span id="error" style="color: red; display:none;"> field is required</span>
                </div>
                <div class="col-12 m-0 p-0 content">
                    ...
                    <div class="row rss-first rss-second mt-0" id="table_error" style="display:none;">
                        ...
                        <div class=" col-9">
                            ...
                            <p id="table_text_error" class="text-error more-info-err" style="color: red;"></p>
                    ...
                    <div class=" col-10 rss-second rss-section" style="    padding-right: 0px;    padding-left: 50px;">
                        <div class="row">
                            ...
                            <div class="col-8">
                                    ...
                                    <div class=" col-8 p-0">
                                        <div class="row">
                                            <div class="col-11 pr-0 p-0">
                                                <input name="name"id="rss_name" class="form-control "
                                                    style="background:#F7F7F7 ;border:0;    width: 102%;"
                                                    placeholder="RSS feed name" type="text">
                                                <p class="text-error more-info-err" style="color: red; display:none;"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class=" col-8 p-0">
                                        <div class="row">
                                            <div class="col-11 pr-0 p-0 crone_job">
                                                ...
                                                <div>
                                                    @php
                                                        $hours = $number = range(0, 24);
                                                        $mins = $number = range(0, 60);
                                                    @endphp
                                ...
                                <div class="row rss-first rss-second"
                                    style="margin-top:-10px;padding-left:0px; display:none;" id="timee_error">
                                    <div class="col-3 rss-first-link">
                                        <span> </span>
                                    </div>
                                    <div class=" col-8 p-0">
                                        <p class="text-error more-info-err" style="color: red;">This field is required</p>
                                    </div>
                                </div>
                                <div class="row rss-first rss-second" style="margin-top:30px;padding:0">
                                        ...
                                        <div class="row">
                                            <div class="col-11 pr-0 p-0">
                                                <select name="category_id" class="form-control "
                                                    style="background:#F7F7F7 ;border:0;    width: 102%;" id="content_type">
                                                    <option value="" selected disabled>Please Select</option>
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}">{{ $category->name }}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-error more-info-err" style="color: red; display:none;">This
                                                    field is requerd</p>
                                            </div>
                                                ...
                                                <section id="wrap"
                                                    ...
                                                    <div class="input-container" style="    padding: 0 15px;">
                                                        <input type="text" name="tags" id="tag"
                                                            placeholder="Your tags here…" autofocus>
                            ...
                            <div class="col-4" style="margin-top: 57px;">
                                <div class="row" style="justify-content: center;">
                                    ...
                                    <div class="col-10"
                                        style="padding:  12px ;display: flex; justify-content: center;background: #F7F7F7 0% 0% no-repeat padding-box;border: 0.5px solid #E6E6E6;border-radius: 10px;">
                                        <div class="upload-container">
                                            <input type="file" style="width: 90%;" id="file_upload" name="image" />
                                            <p style="color: #ADADAD;padding-bottom: 15px; font-size: 12px;"> Supports :
                                                PNG, JPG, JPEG2OOO</p>
                                        </div>
                                    </div>
                                    <div class="col-10 loading">
                                        <span
                                            style="color: #242424;font-size :9px;display: flex;justify-content: space-between;"><span
                                                id="uploading">Uploading…</span> <span id="delete_image"><img
                                                    src="{{ asset('rwrite/assets/images/admin/homepage/Group 4119.svg') }}"
                                                    alt=""></span></span>
                    ...
                    <div class="row" style="   margin-top:80px ;justify-content: center;">
                        <a id="submit" type="submit" value=""
                            style="width: 70px;height: 24px;  background: transparent; border: 0;">
                            <div class="btn"
                                style="font-size: 20px;line-height: 1;color: #FFFFFF;width: 189px;  display: flex; align-items: center; justify-content: center;height: 60px;background: #804E08 0% 0% no-repeat padding-box;border-radius: 6px;">
                                Save
                            </div>
                        </a>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Object.keys(jsonData).forEach(function(key) {
                            ...
                            //     Object.keys(jsonData[key]).forEach(function(keychild) {
                            //     var valuechild = keychild;

                            //     rows+='<tr>'+
                            //             '<td><input name="data[]" value="'+value+'_'+valuechild+'" type="text" readonly style="    border: 0; background: transparent; color: #ADADAD;" /></td>'+
                            //             '<td>'+
                            ...
                            // }else{
                            rows += '<tr>' +
                                '<td><input name="data[]" value="' + value +
                                '" type="text" readonly style="    border: 0; background: transparent; color: #ADADAD;" /></td>' +
                                '<td>' +
        ...
        $('#submit').click(function() {
            ...
            if (title == 0 && creator == 0 && discription == 0 && content == 0 && image == 0) {
                ...
                document.getElementById('table_text_error').innerText =
                    "Title & Author & Description & Content and Image are required"
                x = false;
            } else if (title == 1 && creator == 0 && discription == 0 && content == 0 && image == 0) {
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Author & Description & Content and Image are required"
                x = false;
                ...
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Title & Author & Content and Image are required"
                x = false;
            } else if (title == 0 && creator == 0 && discription == 0 && content == 1 && image == 0) {
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Title & Author & Description and Image are required"
                x = false;
            } else if (title == 0 && creator == 0 && discription == 0 && content == 0 && image == 1) {
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Title & Author & Description and Content are required"
                x = false;
            } else if (title == 1 && creator == 1 && discription == 0 && content == 0 && image == 0) {
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Description & Content and Image are required"
                x = false;
                ...
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Author & Description and Content are required"
                x = false;
            } else if (title == 1 && creator == 0 && discription == 0 && content == 1 && image == 0) {
                document.getElementById('table_error').style.display = "flex";
                document.getElementById('table_text_error').innerText =
                    "Author & Description and Image are required"
                x = false;
