...
@section('content')
    ...
    <nav class="table-media">
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a style="    margin-left: 30px;" class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                href="#nav-book" role="tab" aria-controls="nav-home" aria-selected="true" data-id="book"
                onclick="create_Pagination(this)">
                <svg xmlns="http://www.w3.org/2000/svg" width="26.682" height="26.83" viewBox="0 0 26.682 26.83">
                    <g id="Group_394" data-name="Group 394" transform="translate(-3246.454 338.802)">
                        ...
                        <path id="Path_569" data-name="Path 569"
                            d="M3483.985-235.535c0-.375.011-.751,0-1.125a.543.543,0,0,1,.316-.545q2.876-1.633,5.745-3.28c.469-.268.937-.539,1.409-.8a.4.4,0,0,1,.654.382c.007.785,0,1.571,0,2.356a.546.546,0,0,1-.331.514q-3.078,1.753-6.152,3.514c-.325.186-.65.374-.978.554-.375.206-.659.038-.663-.389C3483.982-234.749,3483.985-235.142,3483.985-235.535Zm7.335-4.768c-.125.068-.2.108-.276.151-1.946,1.111-3.886,2.232-5.843,3.325a.7.7,0,0,0-.438.766c.036.356.008.718.008,1.119l1-.571q2.669-1.524,5.336-3.05c.092-.053.213-.079.211-.233C3491.316-239.283,3491.32-239.769,3491.32-240.3Z"
                            transform="translate(-220.898 -90.611)" fill="#fff" />
                        <path id="Path_570" data-name="Path 570"
                            d="M3432.129-124.191q0,1.086,0,2.172a1.208,1.208,0,0,1-.023.285.357.357,0,0,1-.384.288.353.353,0,0,1-.356-.29,1.442,1.442,0,0,1-.022-.312q0-2.146,0-4.291a1.354,1.354,0,0,1,.023-.312.349.349,0,0,1,.358-.286.354.354,0,0,1,.382.289,1.21,1.21,0,0,1,.022.286Q3432.13-125.277,3432.129-124.191Z"
                            transform="translate(-171.945 -197.034)" fill="#fff" />
                    </g>
                </svg>
                <span>Book</span>
            ...
            <a data-id="article" onclick="create_Pagination(this)" class="nav-item nav-link" id="nav-profile-tab"
                data-toggle="tab" href="#nav-article" role="tab" aria-controls="nav-profile" aria-selected="false">
                <svg xmlns="http://www.w3.org/2000/svg" width="21.246" height="26.83" viewBox="0 0 21.246 26.83">
                    <g id="Group_397" data-name="Group 397" transform="translate(-4841.383 -706.887)">
                        <path id="Path_571" data-name="Path 571"
                            d="M4862.627,721.151q0,5.122,0,10.244a2.178,2.178,0,0,1-2.259,2.322q-7.571,0-15.141,0a2.117,2.117,0,0,1-2.153-1.543.292.292,0,0,0-.2-.211,2.119,2.119,0,0,1-1.489-2.116q-.006-10.35,0-20.7a2.132,2.132,0,0,1,2.24-2.253q7.583-.011,15.168,0a2.12,2.12,0,0,1,2.148,1.55.276.276,0,0,0,.181.2,2.143,2.143,0,0,1,1.5,2.187q0,3.534,0,7.068Zm-20.407-1.681q0,5.148,0,10.3a1.44,1.44,0,0,0,.432,1.123,1.508,1.508,0,0,0,1.1.358q4.963,0,9.926,0c1.694,0,3.388,0,5.082,0a1.325,1.325,0,0,0,1.438-1.411q0-10.35,0-20.7a1.315,1.315,0,0,0-1.411-1.408q-7.583-.006-15.167,0a1.342,1.342,0,0,0-1.4,1.449Q4842.223,714.321,4842.22,719.469Zm18.813-9.977v.388c0,6.618-.012,13.236.009,19.854a2.241,2.241,0,0,1-2.349,2.35c-1.1-.042-2.206-.009-3.309-.009q-5.585,0-11.171,0c-.082,0-.2-.049-.24.046s.057.159.108.228a1.416,1.416,0,0,0,1.234.533q5.651-.006,11.3,0c1.235,0,2.471,0,3.706,0a1.43,1.43,0,0,0,1.046-.362,1.455,1.455,0,0,0,.422-1.127q0-10.258,0-20.515a2.747,2.747,0,0,0-.009-.291A1.348,1.348,0,0,0,4861.033,709.493Z"
                            transform="translate(0)" fill="#4e4e4e" />
                        <path id="Path_572" data-name="Path 572"
                            d="M4898.16,946.071h-5.607a2.319,2.319,0,0,1-.238,0,.418.418,0,0,1,0-.835,1.978,1.978,0,0,1,.212,0h11.294a1.28,1.28,0,0,1,.238.007.417.417,0,0,1,0,.828,1.329,1.329,0,0,1-.238.006Z"
                            transform="translate(-46.965 -221.481)" fill="#4e4e4e" />
                        <path id="Path_573" data-name="Path 573"
                            d="M4898.158,851.91h-5.613a1.56,1.56,0,0,1-.264-.008.383.383,0,0,1-.348-.373.376.376,0,0,1,.282-.423,1.089,1.089,0,0,1,.313-.034q5.652,0,11.3,0a1.11,1.11,0,0,1,.313.034.376.376,0,0,1,.286.421.385.385,0,0,1-.345.376,1.511,1.511,0,0,1-.264.008Z"
                            transform="translate(-46.973 -133.984)" fill="#4e4e4e" />
                        <path id="Path_574" data-name="Path 574"
                            d="M4898.19,992.328h5.661a1.093,1.093,0,0,1,.263.013.39.39,0,0,1,.322.37.4.4,0,0,1-.281.428.841.841,0,0,1-.314.028h-11.321a1.064,1.064,0,0,1-.263-.017.415.415,0,0,1,.035-.816,1.28,1.28,0,0,1,.237-.007Z"
                            transform="translate(-46.976 -265.247)" fill="#4e4e4e" />
                        <path id="Path_575" data-name="Path 575"
                            d="M4898.18,899h-5.66a1.138,1.138,0,0,1-.263-.011.388.388,0,0,1-.326-.366.393.393,0,0,1,.275-.431.907.907,0,0,1,.34-.03h11.268a2.1,2.1,0,0,1,.211,0,.415.415,0,0,1,.408.432.406.406,0,0,1-.434.4c-.5.007-1,0-1.508,0Z"
                            transform="translate(-46.97 -177.739)" fill="#4e4e4e" />
                        <path id="Path_576" data-name="Path 576"
                            d="M4898.2,804.888h-5.612a1.68,1.68,0,0,1-.316-.013.41.41,0,0,1-.033-.8,1.247,1.247,0,0,1,.315-.026q5.638,0,11.277,0a1.173,1.173,0,0,1,.314.028.409.409,0,0,1-.043.8,1.616,1.616,0,0,1-.29.012Z"
                            transform="translate(-46.978 -90.291)" fill="#4e4e4e" />
                        <path id="Path_577" data-name="Path 577"
                            d="M4898.17,757.061h5.612a1.506,1.506,0,0,1,.316.016.409.409,0,0,1,.01.8,1.373,1.373,0,0,1-.315.021h-11.25c-.044,0-.088,0-.132,0-.321-.012-.5-.164-.493-.426s.181-.406.51-.407Q4895.3,757.059,4898.17,757.061Z"
                            transform="translate(-46.959 -46.625)" fill="#4e4e4e" />
                    </g>
                </svg>
            ...
            <a data-id="video_film" onclick="create_Pagination(this)" class="nav-item nav-link" id="nav-contact-tab"
                data-toggle="tab" href="#nav-video" role="tab" aria-controls="nav-contact" aria-selected="false">
            ...
            <a data-id="album_cover" onclick="create_Pagination(this)" class="nav-item nav-link" id="nav-contact-tab"
                data-toggle="tab" href="#nav-cover" role="tab" aria-controls="nav-contact" aria-selected="false">
            ...
            <a data-id="art" onclick="create_Pagination(this)" class="nav-item nav-link" id="nav-contact-tab"
                data-toggle="tab" href="#nav-art" role="tab" aria-controls="nav-contact" aria-selected="false">
        ...
        <div class="media-content tab-content" id="nav-tabContent">
            ...
            <table class="table table-index  tab-pane fade show active" id="nav-book">
                @if (count($books) != 0)
                    <thead class="spacer">
                        ...
                        <th class="cell-name">username</th>
                ...
                <tbody>
                    ...
                    @foreach ($books as $book)
                        <tr>
                            ...
                            <td><a href="/article/view/{{ $book->id }}">{{ $book->title }}</a></td>
                            @if (isset($book->user))
                                <td>
                                    <div class="user-image">
                                        <img src="{{ $book->user->image }}"onerror="this.onerror=null;this.src='{{ asset('\assets/img/logo/logo.svg') }}';"
                                            width="40px" height="auto" />{{ $book->user->username }}
                                    </div>
                                </td>
                            ...
                            <td class="cell-action">
                                ...
                                <select name="" id=""onchange="getval(this,{{ $book->id }});"
                                    class="cell-select" data-title="{{ $book->title }}">
                                    <option value="0"@if ($book->approved == 0) selected @endif>Unapproved
                                    </option>
                                    <option value="1"@if ($book->approved == 1) selected @endif>Approved
                                    </option>
                                </select>
                                ...
                                <button type="button" class="pop" data-toggle="modal"
                                    ...
                                    <div class="delete">
                                        <span>Delete</span>
                                        <img src="{{ asset('rwrite/assets/images/admin/homepage/trash-bin.svg') }}"
                                            alt="">
                                    </div>
                                </button>
                            </td>
                        ...
                        <div class="modal fade approval" id="changeApproval_{{ $book->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                                    ...
                                    <div class="modal-footer border-0 justify-content-center">
                                        <button type="button" class="btn btn-secondary clo"
                                            data-dismiss="modal">Close</button>
                                        <a id="change" href="" class="btn btn-danger">Change</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <tbody id="nav-book">
                    ...
                    @foreach ($articles as $article)
                        <tr>
                            ...
                            <td><a href="/article/view/{{ $article->id }}">{!! Str::limit($article->title, $limit = 20, $end = '...') !!}</a></td>
                            @if (isset($article->user))
                                <td>
                                    <div class="user-image">
                                        <img src="{{ $article->user->image }}"onerror="this.onerror=null;this.src='{{ asset('\assets/img/logo/logo.svg') }}';"
                                            width="40px" height="auto" />{{ $article->user->username }}
                                    </div>
                                </td>
                            ...
                            <td class="cell-action">
                                ...
                                <select name="" id=""onchange="getval(this,{{ $article->id }});"
                                    class="cell-select" data-title="{{ $article->title }}">
                                    <option value="0"@if ($article->approved == 0) selected @endif>Unapproved
                                    </option>
                                    <option value="1"@if ($article->approved == 1) selected @endif>Approved
                                    </option>
                                </select>
                        ...
                        <div class="modal fade approval" id="changeApproval_{{ $article->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
            ...
            <table class="table table-index tab-pane fade" id="nav-video">
                ...
                <tbody id="nav-book">
                    ...
                    ?>
                    @foreach ($video_films as $video_film)
                        <tr>
                            <td>{{ $video_films_counter }}.</td>
                            <td><a href="/article/view/{{ $video_film->id }}">{{ $video_film->title }}</a></td>
                            <td>
                                <div class="user-image">
                                    <img src="{{ $video_film->user->image }}"onerror="this.onerror=null;this.src='{{ asset('\assets/img/logo/logo.svg') }}';"
                                        width="40px" height="auto" />{{ $video_film->user->username }}
                                </div>
                            </td>
                            ...
                            <td class="cell-action">
                                ...
                                <select name="" id=""onchange="getval(this,{{ $video_film->id }});"
                                    class="cell-select" data-title="{{ $video_film->title }}">
                                    <option value="0"@if ($video_film->approved == 0) selected @endif>Unapproved
                                    </option>
                                    <option value="1"@if ($video_film->approved == 1) selected @endif>Approved
                                    </option>
                        ...
                        <div class="modal fade approval" id="changeApproval_{{ $video_film->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
                ...
                <tbody id="nav-book">
                    ...
                    @foreach ($album_covers as $album_cover)
                        <tr>
                            ...
                            <td><a href="/article/view/{{ $album_cover->id }}">{{ $album_cover->title }}</a></td>
                            <td>
                                <div class="user-image">
                                    <img src="{{ $album_cover->user->image }}"onerror="this.onerror=null;this.src='{{ asset('\assets/img/logo/logo.svg') }}';"
                                        width="40px" height="auto" />{{ $album_cover->user->username }}
                                </div>
                            </td>
                            ...
                            <td class="cell-action">
                                ...
                                <select name=""
                                    id="select_{{ $album_cover->id }}"onchange="getval(this,{{ $album_cover->id }});"
                                    class="cell-select" data-title="{{ $album_cover->title }}">
                                    <option value="0"@if ($album_cover->approved == 0) selected @endif>Unapproved
                                    </option>
                                    <option value="1"@if ($album_cover->approved == 1) selected @endif>Approved
                                    </option>
                                </select>
                                <button type="button" class="pop" data-toggle="modal"
                        ...
                        <div class="modal fade approval" id="changeApproval_{{ $album_cover->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
            ...
            <table class="table table-index tab-pane fade" id="nav-art">
                ...
                <tbody id="nav-book">
                    ...
                    @foreach ($arts as $art)
                        <tr>
                            <td>{{ $arts_counter }}.</td>
                            <td><a href="/article/view/{{ $art->id }}">{{ $art->title }}</a></td>
                            <td>
                                <div class="user-image">
                                    <img src="{{ $art->user->image }}"onerror="this.onerror=null;this.src='{{ asset('\assets/img/logo/logo.svg') }}';"
                                        width="40px" height="auto" />{{ $art->user->username }}
                                </div>
                            </td>
                            ...
                            <td class="cell-action">
                                ...
                                <select name="" id=""onchange="getval(this,{{ $art->id }});"
                                    class="cell-select" data-title="{{ $art->title }}">
                                    <option value="0"@if ($art->approved == 0) selected @endif>Unapproved
                                    </option>
                                    <option value="1"@if ($art->approved == 1) selected @endif>Approved
                                    </option>
                                </select>
                                <button type="button" class="pop" data-toggle="modal"
                        ...
                        <div class="modal fade approval" id="changeApproval_{{ $art->id }}" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body">
...
@section('scripts')
    <script>
        function create_Pagination(elem) {
            /* $('#pagination_books').style.display="none";
             $('#pagination_articles').style.display="none";
             $('#pagination_video_films').style.display="none";
             $('#pagination_album_covers').style.display="none";
             $('#pagination_arts').style.display="none";
    ...
    <script>
        function getval(sel, id) {
            ...
            // if ($(this).val() == 'ES')
            // $($('#select_'+id+' option:selected').attr("data-target")).style.display="block"
            //console.log( $($('#select_'+id+' option:selected').attr("data-target")))

            //sel.setAttribute("data-toggle", "modal");
            //sel.setAttribute("data-target", "#changeApproval_"+id);



            //sel.removeAttribute("data-toggle");
            //sel.removeAttribute("data-target");
            /*document.getElementById('changeApproval').classList.add('show');
            document.getElementById('changeApproval').style.paddingRight="17px";
            document.getElementsByTagName('body')[0].classList.add('modal-open');
             document.getElementsByTagName('body')[0].style.paddingRight="17px";
              document.getElementById('changeApproval').removeAttribute("aria-hidden");
               document.getElementById('changeApproval').setAttribute("aria-modal", "true");
            document.getElementById('changeApproval').style.display="block";*/

        }

        /* function close(id){
         	console.log(id);
            document.getElementById('select_'+id).removeAttribute("data-toggle");
            document.getElementById('select_'+id).removeAttribute("data-target");
         }*/



        /*let tbuttons = document.querySelectorAll(
                    ".approval"
                );
               $('body').click(function() {

             tbuttons.forEach((elem) => {
             	console.log(elem.style.display);
             	if(elem.style.display=='block'){                                                                                             
             		
             		$('body').click(function() {
                  let gridRemoveToWishListbuttons = document.querySelectorAll(
                    ".cell-select"
                );
                  gridRemoveToWishListbuttons.forEach((select) => {
                     select.removeAttribute("data-toggle");
                     select.removeAttribute("data-target");
                });
                     });
