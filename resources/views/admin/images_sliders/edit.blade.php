...
@endif
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="signupForm"  method="POST"  action="{!! url('/admin/update_image_slider', ['id' => $image_slider->id]) !!}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                  <input type="text" class="form-control" id="input-19" name="order" value='{{$image_slider->order}}' required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                  <input type="file" class="form-control" id="input-7" name="image"  >
                  </div>
